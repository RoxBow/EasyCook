...
import { Textarea, Label, Item, Input, Form, Button } from 'native-base';
...
class EditUserScreen extends React.Component {
  ...
  render() {
    const { username, email, saveEditUser } = this.props;
    const { firstName, lastName, localization, bio } = this.state;
